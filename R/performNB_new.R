...
#'
#' The main purpose of this function is to be used by \code{\link{nbProbabilities_new}} to
...
#'      }
#' }
#' @seealso \code{\link{nbProbabilities_new}}
#'
#' @export

performNB_new <- function(training, prediction, obsIDVar, goldStdVar,
                         covariates, l = 1,
                         orType = "univariate",
                         nBS = 100, pSampled = 1){
